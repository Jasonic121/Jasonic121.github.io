...
const ProjectCard = ({ project, delay = 0 }) => {
  return (
    <motion.div 
      className={`bg-background/30 border-2 ${project.featured ? 'border-yellow-500/50' : 'border-gray-800'} rounded-lg overflow-hidden transition-all duration-300 ease-out hover:shadow-[0_0_15px_rgba(59,130,246,0.5)] hover:scale-[1.02] hover:-translate-y-2 relative group`}
    ...
    >
      {project.featured && (
        <div className="absolute top-3 right-3 bg-yellow-500 text-white text-xs px-2 py-1 rounded-full flex items-center gap-1 z-10">
